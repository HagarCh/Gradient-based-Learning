...
def train_classifier(train_data, dev_data, num_iterations, learning_rate, params, F2I, L2I):
    ...
    for i in range(num_iterations):
        ...
        for label, features in train_data:
            ...
            params[0] = params[0] - learning_rate * grads[0] # Update weights
            params[1] = params[1] - learning_rate * grads[1] # Update bias
...
if __name__ == "__main__":
    ...
    np.savez('model_params.npz', W=trained_params[0], b=trained_params[1])